...
HD_PWD='E:/SourceTree/AXI-Interface/ip_verify/uart_verify/uart_verify/uart_verify.runs/uart_axi_traffic_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_axi_traffic_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_axi_traffic_gen_0_0.tcl
